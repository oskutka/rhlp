...
restaurants[restaurants.length] = (new Restaurant("purkynka", "Purkyňka", "Purkynka " + createRangeSelector("#content div", (1+(dayOfWeek-1)*6),  (5+(dayOfWeek-1)*6) )));
restaurants[restaurants.length] = (new Restaurant("opice", "U 3 Opic", "Opice #menu>p:not(.dots,#menuTyden)"));
restaurants[restaurants.length] = (new Restaurant("sporthotel", "A-Sport Hotel", "Sporthotel " + createRangeSelector("table.tmaint tr", ((dayOfWeek-1)*7 + 2), (dayOfWeek)*7 + 1)));
...
restaurants[restaurants.length] = (new Restaurant("velorex", "Velorex", "Velorex #denniNabidka"));
